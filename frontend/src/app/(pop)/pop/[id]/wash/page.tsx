...
import WashRecordForm from '@/components/pop/process/WashRecordForm'
import type { WorkOrder, ResultInput } from '@/types/production'

type Tab = 'result' | 'wash'

export default function WashPopPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm">
        <div className="mb-1 flex items-center gap-2">
          ...
          <span className="rounded-full bg-blue-100 px-3 py-0.5 text-xs font-bold text-blue-700">세척 공정</span>
        </div>
      ...
      <div className="rounded-2xl bg-white shadow-sm">
        ...
        <div className="p-5">
          ...
          {activeTab === 'wash' && (
            <WashRecordForm workOrderId={id} onSaved={() => {}} />
          )}
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="flex h-[60px] items-center justify-center rounded-xl border-2 border-gray-300 px-8 text-base font-semibold text-gray-600 hover:bg-gray-50"
        >
          목록으로
        </button>
      </div>
