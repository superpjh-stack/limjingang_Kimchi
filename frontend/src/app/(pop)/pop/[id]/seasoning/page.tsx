...
import SeasoningRecordForm from '@/components/pop/process/SeasoningRecordForm'
import type { WorkOrder, ResultInput } from '@/types/production'

type Tab = 'result' | 'seasoning'

export default function SeasoningPopPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm">
        <div className="mb-1 flex items-center gap-2">
          ...
          <span className="rounded-full bg-red-100 px-3 py-0.5 text-xs font-bold text-red-700">양념버무림 공정</span>
        </div>
      ...
      <div className="rounded-2xl bg-white shadow-sm">
        <div className="flex border-b border-gray-200">
          ...
          <button
            ...
            className={`flex-1 py-4 text-base font-bold transition-colors ${
              activeTab === 'seasoning' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            버무림기록
          </button>
        ...
        <div className="p-5">
          ...
          {activeTab === 'seasoning' && (
            <SeasoningRecordForm workOrderId={id} onSaved={() => {}} />
          )}
        </div>
      </div>
